...
import CategoryWidget from '../Post/CategoryWidget'
import RecentRelatedPostsWidget from '../Post/RecentRelatedPostsWidget'
import AuthorPostsWidget from '../Post/AuthorPostsWidget'
import PostDetails from './PostDetails'
import Author from './Author'
import CommentForm from './CommentForm'
import Comments from './Comments'
import { getPost } from './../../graphql/graphql'
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    getPost(slug).then(data => setPost(data)).catch(error=>setError(true)).then(()=>setLoading(false))
  }, [slug]);

  const categorySlug = post?.category?.[0]?.categorySlug;
  const postSlug = post?.postSlug
  console.log("index post is ", postSlug)
  ...
  return (
    <div className='px-10 flex flex-row relative'>
      ...
      <div className='w-[50%] space-y-4 mt-8 ml-[32px]'>
      ...
      <div className='w-[25%] relative'>
        <div className='flex flex-col sticky top-28 space-y-4 overflow-y-auto'>
            ...
            <RecentRelatedPostsWidget category={categorySlug} slug={slug} />
